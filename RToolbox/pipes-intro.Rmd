...
Since version **4.2.0**, **R** has now a built-in pipeline operator `|>` that 
according to the help file "is more streamlined".


For the examples, currently found in this document, both versions work 
identically. There are a few differences regarding so-called placeholders, 
that you may find somewhere else. It will be explained in future versions of the slides.
